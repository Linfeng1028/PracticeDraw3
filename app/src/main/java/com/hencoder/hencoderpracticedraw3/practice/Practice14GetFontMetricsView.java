...
public class Practice14GetFontMetricsView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float height = -(fontMetrics.ascent + fontMetrics.descent) / 2;
        int middle = (top + bottom) / 2;
        canvas.drawText(texts[0], 100, middle + height, paint2);
        canvas.drawText(texts[1], 200, middle + height, paint2);
        canvas.drawText(texts[2], 300, middle + height, paint2);
        canvas.drawText(texts[3], 400, middle + height, paint2);
        canvas.drawText(texts[4], 500, middle + height, paint2);
        canvas.drawText(texts[5], 600, middle + height, paint2);
    }
}
